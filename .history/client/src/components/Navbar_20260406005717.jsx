    ...
    <nav className={`navbar ${scrolled || !isHome ? 'scrolled' : ''}`}>
      ...
      <div className={`nav-links ${menuOpen ? 'open' : ''}`}>
        ...
        {isAuthenticated && isSeller && (
          <>
            <Link to="/seller/dashboard" className={location.pathname.includes('seller') ? 'active' : ''}>
      ...
      <div className="nav-actions">
        {isAuthenticated ? (
          ...
          <>
            <Link to="/login" className="btn btn-outline" style={!isHome || scrolled ? { borderColor: 'var(--primary)', color: 'var(--primary)' } : {}}>
              Login
            </Link>
