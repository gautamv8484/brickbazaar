  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (loginAttempts >= 4) {
        ...
        toast.error(
          `${message}. Make sure you selected the correct role (${role}).`,
        );
      } else {
        toast.error(message);
      }
    ...
    <div className="auth-page">
        ...
        <div className="auth-left-content">
          ...
          {loginAttempts >= 3 && (
            <div className="login-warning">
              <FiAlertCircle />
              <span>
                {loginAttempts} failed attempts. Account may be temporarily
          ...
          <form className="auth-form" onSubmit={handleSubmit} noValidate>
            ...
            {/* Password */}
            <div
              className={`form-group ${hasError("password") ? "has-error" : ""}`}
            >
              <label>
                <FiLock /> Password
              </label>
      ...
      <div className="auth-right">
        <div className="auth-right-content">
          ...
          <p>
            Access thousands of construction materials from verified suppliers
            at the best prices.
          </p>
        </div>
      </div>
