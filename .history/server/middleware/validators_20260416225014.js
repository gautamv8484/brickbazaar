...
const createOrderValidator = [
  ...
  body('deliveryAddress')
    .if(body('transportRequired').equals('true').or(body('transportRequired').equals(true)))
    .trim()
    .notEmpty().withMessage('Delivery address is required when transport is selected')
    .isLength({ min: 5, max: 300 }).withMessage('Delivery address must be 5-300 characters'),
